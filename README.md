...
Each recipe has a dedicated detail page displaying: • Recipe image • Ingredient list with measurements • Cooking instructions • YouTube tutorial (if available)
...
Technologies Used • React.js • React Router DOM • Axios • Tailwind CSS • JavaScript (ES6+) • TheMealDB API

The application uses the following endpoints from TheMealDB:

Search by ingredient:https://www.themealdb.com/api/json/v1/1/filter.php?i=INGREDIENT Fetch full recipe details:https://www.themealdb.com/api/json/v1/1/lookup.php?i=ID
...
Installation 1. Clone the repository:git clone https://github.com/your-username/recipe-finder.git 2. Navigate to the project directory:cd recipe-finder 3. Install dependencies:npm install 4. Run the development server:npm run dev
